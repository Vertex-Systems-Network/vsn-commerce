...
class ProductAlertResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'targetPriceMinor' => $this->target_price_minor,
            'lastObservedPriceMinor' => $this->last_observed_price_minor,
            'lastObservedStock' => $this->last_observed_stock,
            'triggeredAt' => $this->triggered_at?->toIso8601String(),
