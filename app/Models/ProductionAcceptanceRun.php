...
class ProductionAcceptanceRun extends Model
{
    ...
    protected function casts():array{return ['checks'=>'array','evaluated_at'=>'datetime','approved_at'=>'datetime'];}
    /** Returns route key name. */
    public function getRouteKeyName():string{return 'public_id';}
    /** Handles signoffs for the production acceptance run workflow. */
    public function signoffs(){return $this->hasMany(ProductionAcceptanceSignoff::class,'acceptance_run_id');}
    ...
    public function releaseCandidateManifest(){return $this->hasOne(ReleaseCandidateManifest::class,'acceptance_run_id');}
}
