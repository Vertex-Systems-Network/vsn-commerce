...
class FinanceDashboardService
{
    ...
    public function summary():array
    {
        ...
        $gameMinor=(int)Game::query()->whereIn('games.status',[GameStatus::WinnerSelected->value])->join('products','products.id','=','games.product_id')->sum('products.base_price_minor');
