...
export default function VendorShell(){
  ...
  return <div className={`vendor-app-shell ${open?'nav-open':''}`}><button className="shell-overlay" aria-label="Close navigation" onClick={/** Inline callback for this operation. */ ()=>setOpen(false)}/><aside className="vendor-sidebar" aria-label="Seller navigation">
